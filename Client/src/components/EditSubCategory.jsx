      ...
      <div className="w-full max-w-5xl bg-white p-4 rounded">
        ...
        <form className="my-3 grid gap-3" onSubmit={handleSubmitSubCategory}>
          ...
          <div className="grid gap-1">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-3">
              ...
              <label htmlFor="uploadSubCategoryImage">
                <div
                  className="px-4 py-1 border border-yellow-150 text-yellow-400 rounded
          ...
          <div className="grid gap-1">
            ...
            <div className="border focus-within:border-yellow-200 rounded">
              {/**display value */}
          ...
          <button className={`px-4 py-1 border
                ${subCategoryData.name && subCategoryData.image && subCategoryData.category[0] ? "bg-yellow-400 hover:bg-yellow-200" : "bg-gray-200"}
            `}>
            Submit
            </button>
        </form>
